from app.functions.web_scans_vulnerabilities.w3af_api_client.utils.details import Details
from app.functions.web_scans_vulnerabilities.w3af_api_client.traffic import Traffic
